      ...
      <div className="min-h-screen">
        <div className="bg-amber-900 text-white p-4">
          <div className="container mx-auto flex items-center justify-between">
            <h1 className="text-xl font-bold">Bond Coffee - Адмін панель</h1>
            <button
              onClick={() => setShowAdmin(false)}
              className="bg-amber-800 hover:bg-amber-700 px-4 py-2 rounded-lg text-sm"
            >
    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-amber-100">
      ...
      <div className="fixed bottom-4 right-4 z-40">
        <button
          ...
          className="bg-amber-900 hover:bg-amber-800 text-white p-3 rounded-full shadow-lg transition-colors"
          title="Адмін панель"
        >
